...
import com.jackpan.findchurch.BuildConfig;
...
public class VersionChecker implements RequestResponseListener {
    ...
    public void compareVersion(String html)
    {
        ...
        Log.d("Jack_news",onlineVersion);
        String appVersion = getAppVersion();
        Log.d("Jack_old",appVersion);
    ...
    public boolean isHeigherVersion(String oldVersion, String newVersion)
    {
        try {
            ...
            Log.d("Jack_old",olds.length+"");
            Log.d("Jack_news",news.length+"");
            for (int i=0; i<olds.length; i++)
            {
                ...
                if      (n > o) {
                    Log.d("Jack_news","true");
                    return true;
//                    return  false;
                }
                else if (n == o) {
                    Log.d("Jack_news","same");
                    continue;
                }else if(n < o) {
                    Log.d("Jack_news","false");
                    return false;
//                    return true;
            }
            }
